...
- 68 narraciones MP3 de ElevenLabs incluidas en español e inglés; cambio de idioma y ritmo, atenuación musical durante la voz, cancelación en segundo plano y alternativa del sistema si falta un archivo.
...
- 31 pruebas: recorridos completos y en distinto orden, acciones duplicadas/tardías, conservación de progreso, migración, recuperación de datos inválidos, arrastre y todos los atlas y guiones.
...
- Los 68 archivos ElevenLabs se decodificaron con FFmpeg: duración de 1,115 a 5,108 segundos, ninguna pista silenciosa y pico máximo 0,8974. Hash SHA-256 de cada pista cotejado con el manifiesto del proveedor; no quedan voces Microsoft mezcladas en el lote.
